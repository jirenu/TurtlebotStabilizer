...
if("FALSE" STREQUAL "TRUE")
  set(phidgets_imu_SOURCE_PREFIX /home/servicerobot2/catkin_ws2/src/phidgets_drivers/phidgets_imu1)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/servicerobot2/catkin_ws2/install/${idir}'.  Ask the maintainer 'Martin Guenther <martin.guenther@dfki.de>, Murilo FM <muhrix@gmail.com>' to fix it.")
    endif()
