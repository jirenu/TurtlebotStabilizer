...
if("FALSE" STREQUAL "TRUE")
  set(phidgets_imu_SOURCE_PREFIX /home/servicerobot2/catkin_ws2/src/phidgets_drivers1/phidgets_imu1)
  set(phidgets_imu_DEVEL_PREFIX /home/servicerobot2/catkin_ws2/devel)
  ...
  set(phidgets_imu_INSTALL_PREFIX /home/servicerobot2/catkin_ws2/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Murilo FM <muhrix@gmail.com>, Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/servicerobot2/catkin_ws2/install/${idir}'.  Ask the maintainer 'Murilo FM <muhrix@gmail.com>, Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
    endif()
    _list_append_unique(phidgets_imu_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "phidgets_imu;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
set(depends "geometry_msgs;nodelet;pluginlib;phidgets_api;roscpp;sensor_msgs;std_msgs;std_srvs;tf")
