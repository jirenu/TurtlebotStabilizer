...
if("TRUE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /home/servicerobot2/catkin_ws2/src/robot_model/collada_urdf)
  set(collada_urdf_DEVEL_PREFIX /home/servicerobot2/catkin_ws2/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /home/servicerobot2/catkin_ws2/install)
...
if(NOT "/home/servicerobot2/catkin_ws2/src/robot_model/collada_urdf/include " STREQUAL " ")
  set(collada_urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/servicerobot2/catkin_ws2/src/robot_model/collada_urdf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/servicerobot2/catkin_ws2/src/robot_model/collada_urdf/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
