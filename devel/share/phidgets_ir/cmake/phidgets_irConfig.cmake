...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_ir_SOURCE_PREFIX /home/servicerobot2/catkin_ws2/src/phidgets_drivers1/phidgets_ir1)
  set(phidgets_ir_DEVEL_PREFIX /home/servicerobot2/catkin_ws2/devel)
  ...
  set(phidgets_ir_INSTALL_PREFIX /home/servicerobot2/catkin_ws2/install)
...
if(NOT "/home/servicerobot2/catkin_ws2/src/phidgets_drivers1/phidgets_ir1/include " STREQUAL " ")
  set(phidgets_ir_INCLUDE_DIRS "")
  set(_include_dirs "/home/servicerobot2/catkin_ws2/src/phidgets_drivers1/phidgets_ir1/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'phidgets_ir' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Murilo FM <muhrix@gmail.com>, Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'phidgets_ir' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/servicerobot2/catkin_ws2/src/phidgets_drivers1/phidgets_ir1/${idir}'.  Ask the maintainer 'Murilo FM <muhrix@gmail.com>, Ivan Dryanovski <ccnyroboticslab@gmail.com>' to fix it.")
    endif()
